...
export default function SignIn(){
    return (
        ...
        <div className="flex h-screen w-screen items-center justify-center bg-slate-500">
            ...
            <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path clip-rule="evenodd" fill-rule="evenodd" d="M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z"></path>
                ...
                <div>
                    ...
                    <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Login in to your account</h2>      
                </div>
            ...
            <div className="flex justify-end">
                <div>Need an account?<Link href={"signup"}><span className="px-2 font-bold">Sign up</span></Link></div>
            </div>
